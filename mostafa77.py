...
print " %smostafa%s taiz%s 73 %s28-09-2022%s (3:40)%s" % (W, B, R, C, Y, N)

print " %sDevelop by: %sMostafa aldobaei %s$$$%s Mostafa aldobaei%s" % (W, R, W, Y, N)
print "                      %smy number %s967737572399%s" % (W, R, N)

print " %sCode: %sPython%s" % (W, C, N)

print " %sFB: %shttps://www.facebook.com/profile.php?id=100078426657327%s" % (W, B, N)
...
if bahasa.strip() in "01 1".split():
  ...
  tahap3 = raw_input("%s3%s)%s Sekarang masuk ke profilmu dan cari 15 digit kode profilmu. Contoh punya%s saya %s(%s 100078426657327 %s)%s...%s[%sEnter%s]%s" % (Y, C, W, R, C, B, C, W, C, Y, C, N))
  ...
  step3 = raw_input("%s3%s)%s Now Go To Your Profile And Find Your 15 Digits Profile Code. Example %s(%s 100078426657327 %s)%s...%s[%sEnter%s]%s" % (Y, C, W, C, B, C, W, C, Y, C, N))
  ...
  tahap3 = raw_input("%s3%s)%s Agora tama ba ita boot nia profil no buka 15 digit kode profil ita boot nian. Exemplo%s hau nian %s(%s 100078426657327 %s)%s...%s[%sEnter%s]%s" % (Y, C, W, R, C, B, C, W, C, Y, C, N))
